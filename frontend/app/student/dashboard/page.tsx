  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <nav className="bg-white border-b px-6 py-4 flex items-center justify-between">
        <span className="font-bold text-lg text-blue-600">tutorIA — Alumno</span>
        <div className="flex items-center gap-4">
          {user.is_professor && (
            <button
              onClick={() => { setActiveRole("professor"); router.push("/dashboard"); }}
      ...
      <main className="max-w-4xl mx-auto p-8">
        ...
        <p className="text-gray-500 mb-8">Continúa tu aprendizaje</p>
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          >
            ...
            <p className="text-sm text-gray-500">Ve los cursos en los que estás inscrito</p>
          </button>
        </div>
      </main>
    </div>
